...
private struct CaptureTypesHelpPageView: View {
    ...
    var body: some View {
        TutorialPageView(pageName: LocalizedString.title,
                         ...
                         sections: [SectionObjectCapture(title: LocalizedString.objectModeTitle,
                                            body: objectMode,
                                            symbol: nil, symbolColor: nil),
                                    SectionObjectCapture(title: LocalizedString.areaModeTitle,
                                            body: areaMode,
                                            symbol: nil, symbolColor: nil)])
    }
...
private struct HowToCaptureHelpPageView: View {
    ...
    var body: some View {
        TutorialPageView(pageName: LocalizedString.title,
                         ...
                         imageCaption: LocalizedString.caption,
                         sections: [SectionObjectCapture(title: LocalizedString.firstSetOfTipsTitle,
                                            body: LocalizedString.firstSetOfTips,
                                            symbol: "checkmark.circle", symbolColor: .green),
                                    SectionObjectCapture(title: LocalizedString.secondSetOfTipsTitle,
